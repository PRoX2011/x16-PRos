...
TRAMPOLINE_ADDR equ 0xF000
TRAMPOLINE_BIN  equ 0xF100
TRAMPOLINE_SELF equ 0xF110
TRAMPOLINE_FILE equ 0xF120
TRAMPOLINE_FLAG equ 0xF130
TRAMPOLINE_ARGS equ 0xF131
TRAMPOLINE_MSG  equ 0xF160
